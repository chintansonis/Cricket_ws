...
public class RequestedListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private RequestedListAdapter requestedListAdapter;

    @SuppressLint({"ValidFragment", "Unused"})
    private RequestedListFragment() {

    }

    @SuppressLint("ValidFragment")
    private RequestedListFragment(BaseActivity activity) {
        setBaseActivity(activity);
    }

    public static BaseFragment getFragment(BaseActivity activity) {
        BaseFragment fragment = new RequestedListFragment(activity);
        return fragment;
    }
    ...
    private void getRequestedListApi() {
        ...
        RestClient.get().getRequestedList("5").enqueue(new Callback<List<ResponsePending>>() {
            @Override
    ...
    private void setAdapter() {
        ...
        requestedListAdapter = new RequestedListAdapter(getBaseActivity(), pendingObjectArrayList);
