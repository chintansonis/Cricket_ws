...
import com.cricket.cricketchallenge.custom.view.CirclePageIndicator;
import com.cricket.cricketchallenge.helper.AppConstants;
import com.cricket.cricketchallenge.widget.intro.MaterialTutorialAdapter;
import com.cricket.cricketchallenge.widget.intro.MaterialTutorialPresenter;
import com.cricket.cricketchallenge.widget.intro.MaterialTutorialFragment;
import com.cricket.cricketchallenge.helper.Functions;
import com.cricket.cricketchallenge.widget.intro.MaterialTutorialContract;
...
public class MaterialTutorialActivity extends AppCompatActivity implements MaterialTutorialContract.View {
    ...
    public void showEndTutorial() {
        ...
        intent.putExtra(AppConstants.INTENT_EXTRA_BUTTON_CLICK, AppConstants.getStartedClick);
    ...
    public void showLoginView() {
        Intent intent = new Intent(this, StartUpActivity.class);
        intent.putExtra(AppConstants.INTENT_EXTRA_BUTTON_CLICK, AppConstants.loginClick);
        setResult(RESULT_OK, intent);
        finish();
    }
}
