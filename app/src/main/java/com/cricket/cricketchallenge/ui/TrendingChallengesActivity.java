...
import com.cricket.cricketchallenge.adapters.TrendingChallengeAdapter;
import com.cricket.cricketchallenge.custom.TfTextView;

/**
 * Created by chintans on 13-12-2017.
 */

public class TrendingChallengesActivity extends BaseActivity {
    ...
    private TrendingChallengeAdapter trendingChallengeAdapter;
    ...
    private void setAdapter() {
        rvTrending.setLayoutManager(new LinearLayoutManager(TrendingChallengesActivity.this));
        trendingChallengeAdapter = new TrendingChallengeAdapter(TrendingChallengesActivity.this);
        rvTrending.setAdapter(trendingChallengeAdapter);
    }
